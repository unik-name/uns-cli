...
export const shouldExit = [
    {
        ...
        args: ["swap", "--network", "dalinet"],
        exitCode: 2,
    },
    {
        description: "Should exit with code 1 if recipient ETH address is invalid",
        args: ["swap", "--network", "dalinet", "10", "toto"],
        exitCode: 1,
        mocks: {
    ...
    },
    {
        ...
        args: ["swap", "--network", "dalinet", "10"],
        exitCode: 2,
    },
    {
        description: "Should exit with code 1 if amount is not a number",
        args: ["swap", "--network", "dalinet", "abc", "0x76778AeDe1Afc5031FAb1C761C41130F31415424"],
        exitCode: 1,
        mocks: {
            nodeConfigurationCrypto: true,
            blockchain: true,
    ...
    },
    {
        ...
        args: ["swap", "--network", "dalinet", "-10", "0x76778AeDe1Afc5031FAb1C761C41130F31415424"],
        exitCode: 1,
        mocks: {
            nodeConfigurationCrypto: true,
            blockchain: true,
    ...
    {
        description: "Should exit with code 1 if swap cost makes the amount negative",
        args: ["swap", "--network", "dalinet", "-10", "0x76778AeDe1Afc5031FAb1C761C41130F31415424"],
        exitCode: 1,
        mocks: {
            nodeConfigurationCrypto: true,
    ...
    },
    {
        ...
        args: ["swap", "--network", "dalinet", "10.123456789999", "0x76778AeDe1Afc5031FAb1C761C41130F31415424"],
        exitCode: 1,
        mocks: {
            nodeConfigurationCrypto: true,
            blockchain: true,
    ...
    },
    {
        ...
        args: ["swap", "--network", "dalinet", "10.000.00", "0x76778AeDe1Afc5031FAb1C761C41130F31415424"],
        exitCode: 1,
        mocks: {
            nodeConfigurationCrypto: true,
            blockchain: true,
